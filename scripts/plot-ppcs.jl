...
scatter!(axs[1,1], jittered_ρ, vec(F1s[3, 3, :, :, 1]), color=vec(pvals[:, :, 1]), colorscale=log10, colormap=cmr_ember, colorrange=(lowclip, 1.0), lowclip=pv_blue, markersize=5.0)
scatter!(axs[1,2], jittered_ρ, vec(F1s[3, 3, :, :, 2]), color=vec(pvals[:, :, 2]), colorscale=log10, colormap=cmr_ember, colorrange=(lowclip, 1.0), lowclip=pv_blue, markersize=5.0)

Colorbar(fig[1,3], size=8, limits=(lowclip, 1.0), scale=log10, colormap=cmr_ember, lowclip=pv_blue, ticklabelrotation=pi/6, label="Post. pred. p-value")
...
scatter!(axs[2,1], jittered_ρ, vec(F1s[3, 3, :, :, 1]), color=vec(pvals[:, :, 1]), colorscale=log10, colormap=cmr_ember, colorrange=(lowclip, 1.0), lowclip=pv_blue, markersize=5.0)
scatter!(axs[2,2], jittered_ρ, vec(F1s[3, 3, :, :, 2]), color=vec(pvals[:, :, 2]), colorscale=log10, colormap=cmr_ember, colorrange=(lowclip, 1.0), lowclip=pv_blue, markersize=5.0)

Colorbar(fig[2,3], size=8, limits=(lowclip, 1.0), scale=log10, colormap=cmr_ember, lowclip=pv_blue, ticklabelrotation=pi/6, label="Post. pred. p-value")
